...
전문 용어가 나오면 중학교 1학년 눈높이에 맞춰 아주 쉽게 풀어서 설명해주세요."""
    ...
    if search_stage == "Gemini":
        section_prompt = f"주요 역할: 학생의 질문에 자체 지식을 활용하여 답변하되, 질문이 오세아니아 사회 교과 내용과 무관한 경우 절대 답변을 제공하지 말고 학습 내용으로 유도하는 것입니다."
    else:
...
5. [필수 거절 제약] 학생이 사회 교과와 아예 상관없는 엉뚱한 질문을 할 경우에는 절대 지식이나 정답을 알려주지 마세요. "선생님은 사회 수업을 위한 챗봇이에요."라며 정중하게 거절한 뒤, 학습 내용에 다시 집중할 수 있도록 현재 단원과 관련된 흥미로운 추천 질문을 1~2개 직접 제시해주세요. (이 경우에는 안내 문구나 출처 표기를 하지 않습니다.)"""
